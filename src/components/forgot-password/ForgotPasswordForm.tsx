...
import type { ForgotPasswordFormErrors, ForgotPasswordPageMessages } from "@/lib/forgot-password/validateForgotPasswordForm";
import { emailOk } from "@/lib/register/email";

type ForgotPasswordFormProps = {
  t: ForgotPasswordPageMessages;
  email: string;
  ...
  return (
    ...
    >
      ...
      <RegisterIconField
        ...
        errors={errors}
        submitted={submitted}
        validWhenSubmitted={emailOk(email)}
        Icon={Mail}
      />
